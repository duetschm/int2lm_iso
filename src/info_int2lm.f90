...
!  Replaced most 1:LEN_TRIM constructs with TRIM
!
! Code Description:
! Language: Fortran 90.
!==============================================================================
...
CHARACTER (LEN=*), PARAMETER :: INFO_LibraryName = 'int2lm2.0.4'
CHARACTER (LEN=*), PARAMETER :: INFO_RevisionTag = 'https://cosmo.cscs.ch/int2lm/trunk_tags/int2lm_c2sm/int2lm2.0.4'
CHARACTER (LEN=*), PARAMETER :: INFO_CheckinDate = '2014-05-01 02:29:00 +0200 (Thu, 01 May 2014)'
CHARACTER (LEN=*), PARAMETER :: INFO_RevisionNumber = '5498M'
...
CHARACTER (LEN=*), PARAMETER :: INFO_CompilerCall = 'ifort -DGRIBDWD -DNETCDF -O2 -fpp -ip -heap-arrays -g ' // &
    '-traceback'
CHARACTER (LEN=*), PARAMETER :: INFO_CompilerVersion = ''
CHARACTER (LEN=*), PARAMETER :: INFO_DefinedMacros = '-I/opt/parastation/mpi2-intel/include ' // &
    '-I/home2/stephan/include'
CHARACTER (LEN=*), PARAMETER :: INFO_UndefinedMacros = '(missing)'
CHARACTER (LEN=*), PARAMETER :: INFO_DebugOptions = '(missing)'
CHARACTER (LEN=*), PARAMETER :: INFO_LinkOptions = 'ifort -L/opt/parastation/mpi2-intel/lib ' // &
    '-Wl,-rpath,/opt/parastation/mpi2-intel/lib -lmpichf90 -lmpich -L/opt/parastation/lib64 ' // &
    '-Wl,-rpath,/opt/parastation/lib64 -lpscom -lrt -L/home2/stephan/lib -lgrib1 -L/home2/stephan/lib ' // &
    '-lnetcdf'
CHARACTER (LEN=*), PARAMETER :: INFO_CompiledBy = 'duetschm'
CHARACTER (LEN=*), PARAMETER :: INFO_CompileTime = 'Thu Mar  2 11:28:56 CET 2017'
CHARACTER (LEN=*), PARAMETER :: INFO_CompileMachine = 'tempest.ccn'
!
! Global Variables:
!
...
CHARACTER (LEN=80) :: INFO_BinaryName = 'int2lm'
